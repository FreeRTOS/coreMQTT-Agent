...
<tagfile doxygen_version="1.16.1">
  <compound kind="file">
    ...
    <includes id="core__mqtt_8h" name="core_mqtt.h" local="yes" import="no" module="no" objc="no">core_mqtt.h</includes>
    <includes id="core__mqtt__serializer_8h" name="core_mqtt_serializer.h" local="yes" import="no" module="no" objc="no">core_mqtt_serializer.h</includes>
    <includes id="transport__interface_8h" name="transport_interface.h" local="yes" import="no" module="no" objc="no">transport_interface.h</includes>
    <includes id="core__mqtt__state_8h" name="core_mqtt_state.h" local="yes" import="no" module="no" objc="no">core_mqtt_state.h</includes>
    <includes id="core__mqtt__serializer__private_8h" name="core_mqtt_serializer_private.h" local="yes" import="no" module="no" objc="no">private/core_mqtt_serializer_private.h</includes>
    <includes id="core__mqtt__config__defaults_8h" name="core_mqtt_config_defaults.h" local="yes" import="no" module="no" objc="no">core_mqtt_config_defaults.h</includes>
  ...
  <compound kind="file">
    ...
    <member kind="typedef">
      ...
      <anchor>gabdae0fef896929b04ea66ac3c1d4e693</anchor>
      <arglist></arglist>
    </member>
    <member kind="typedef">
      <type>int32_t(*</type>
  ...
  <compound kind="page">
    ...
    <subpage>mqtt_primaryfunctions.html</subpage>
    <subpage>mqtt_serializerfunctions.html</subpage>
    <subpage>mqtt_propertyaddfunctions.html</subpage>
    <subpage>mqtt_propertygetfunctions.html</subpage>
  </compound>
  <compound kind="page">
    <name>mqtt_primaryfunctions</name>
    <title>Primary functions</title>
    <filename>mqtt_primaryfunctions.html</filename>
    <subpage>mqtt_init_function.html</subpage>
    <subpage>mqtt_initstatefulqos_function.html</subpage>
    <subpage>mqtt_initretransmits_function.html</subpage>
    <subpage>mqtt_connect_function.html</subpage>
    <subpage>mqtt_subscribe_function.html</subpage>
    <subpage>mqtt_publish_function.html</subpage>
    <subpage>mqtt_ping_function.html</subpage>
    <subpage>mqtt_unsubscribe_function.html</subpage>
    <subpage>mqtt_disconnect_function.html</subpage>
    <subpage>mqtt_processloop_function.html</subpage>
    <subpage>mqtt_receiveloop_function.html</subpage>
    <subpage>mqtt_getpacketid_function.html</subpage>
    <subpage>mqtt_getsubackstatuscodes_function.html</subpage>
    <subpage>mqtt_status_strerror_function.html</subpage>
    <subpage>mqtt_publishtoresend_function.html</subpage>
  </compound>
  <compound kind="page">
    <name>mqtt_serializerfunctions</name>
    <title>Serializer functions</title>
    <filename>mqtt_serializerfunctions.html</filename>
    <subpage>mqttpropertybuilder_init_function.html</subpage>
    <subpage>mqtt_getconnectpacketsize_function.html</subpage>
    <subpage>mqtt_serializeconnect_function.html</subpage>
    <subpage>mqtt_getsubscribepacketsize_function.html</subpage>
    <subpage>mqtt_serializesubscribe_function.html</subpage>
    <subpage>mqtt_validatesubscribeproperties_function.html</subpage>
    <subpage>mqtt_getunsubscribepacketsize_function.html</subpage>
    <subpage>mqtt_serializeunsubscribe_function.html</subpage>
    <subpage>mqtt_getpublishpacketsize_function.html</subpage>
    <subpage>mqtt_serializepublish_function.html</subpage>
    <subpage>mqtt_serializepublishheader_function.html</subpage>
    <subpage>mqtt_serializepublishheaderwithouttopic_function.html</subpage>
    <subpage>mqtt_validatepublishparams_function.html</subpage>
    <subpage>mqtt_validatepublishproperties_function.html</subpage>
    <subpage>mqtt_serializeack_function.html</subpage>
    <subpage>mqtt_getackpacketsize_function.html</subpage>
    <subpage>mqtt_getdisconnectpacketsize_function.html</subpage>
    <subpage>mqtt_getpingreqpacketsize_function.html</subpage>
    <subpage>mqtt_serializepingreq_function.html</subpage>
    <subpage>mqtt_deserializepublish_function.html</subpage>
    <subpage>mqtt_deserializeack_function.html</subpage>
    <subpage>mqtt_getincomingpackettypeandlength_function.html</subpage>
    <subpage>mqtt_initconnect_function.html</subpage>
  </compound>
  <compound kind="page">
    <name>mqtt_propertyaddfunctions</name>
    <title>Property Add functions</title>
    <filename>mqtt_propertyaddfunctions.html</filename>
    <subpage>mqttpropadd_subscriptionid_function.html</subpage>
    <subpage>mqttpropadd_userprop_function.html</subpage>
    <subpage>mqttpropadd_sessionexpiry_function.html</subpage>
    <subpage>mqttpropadd_connreceivemax_function.html</subpage>
    <subpage>mqttpropadd_connmaxpacketsize_function.html</subpage>
    <subpage>mqttpropadd_conntopicaliasmax_function.html</subpage>
    <subpage>mqttpropadd_connrequestrespinfo_function.html</subpage>
    <subpage>mqttpropadd_connrequestprobinfo_function.html</subpage>
    <subpage>mqttpropadd_connauthmethod_function.html</subpage>
    <subpage>mqttpropadd_connauthdata_function.html</subpage>
    <subpage>mqttpropadd_willdelayinterval_function.html</subpage>
    <subpage>mqttpropadd_pubpayloadformat_function.html</subpage>
    <subpage>mqttpropadd_pubmessageexpiry_function.html</subpage>
    <subpage>mqttpropadd_pubtopicalias_function.html</subpage>
    <subpage>mqttpropadd_pubresponsetopic_function.html</subpage>
    <subpage>mqttpropadd_pubcorrelationdata_function.html</subpage>
    <subpage>mqttpropadd_pubcontenttype_function.html</subpage>
    <subpage>mqttpropadd_reasonstring_function.html</subpage>
  </compound>
  <compound kind="page">
    <name>mqtt_propertygetfunctions</name>
    <title>Property Get functions</title>
    <filename>mqtt_propertygetfunctions.html</filename>
    <subpage>_m_q_t_t_prop_get_payloadformat_function.html</subpage>
    <subpage>_m_q_t_t_prop_get_responsetopic_function.html</subpage>
    <subpage>_m_q_t_t_prop_get_correlationdata_function.html</subpage>
    <subpage>_m_q_t_t_prop_get_messageexpiryinterval_function.html</subpage>
    <subpage>_m_q_t_t_prop_get_contenttype_function.html</subpage>
    <subpage>_m_q_t_t_prop_get_subscriptionid_function.html</subpage>
    <subpage>mqttpropget_userprop_function.html</subpage>
    <subpage>mqttpropget_reasonstring_function.html</subpage>
    <subpage>mqttpropget_sessionexpiry_function.html</subpage>
    <subpage>_m_q_t_t_prop_get_topicaliasmax_function.html</subpage>
    <subpage>_m_q_t_t_prop_get_receivemax_function.html</subpage>
    <subpage>_m_q_t_t_prop_get_maxqos_function.html</subpage>
    <subpage>_m_q_t_t_prop_get_retainavailable_function.html</subpage>
    <subpage>_m_q_t_t_prop_get_maxpacketsize_function.html</subpage>
  </compound>
  <compound kind="page">
